...
The network is designed from scratch using VLAN segmentation, VLSM addressing, Layer 3 switching, 802.1Q trunking, and static routing to provide department isolation while maintaining controlled inter-VLAN communication and Internet access.
